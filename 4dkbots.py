...
Bots = [lineMID,kiMID,ki2MID,ki3MID,ki4MID]
...
admin =["u078444fd2228aa46e9ae00380b6a1478"]
...
#==============================================================================#
                    ...
                    helpMessage = helpmessage()
                    jp1 = ki1.getContact(ki1MID).displayName
                    ki1.sendMessage(to,str(helpMessage) + "╭════════════════════╮\n❨✪❩ ᴠɪᴇᴡ sᴇᴛᴛɪɴɢs = sᴇᴛ \n❨✪❩ ᴠɪᴇᴡ ɪɴғᴏ ʙᴏᴛ = ᴀʙᴏᴜᴛ \n❨✪❩ ʜᴇʟᴘᴍᴇssᴀɢᴇ ʙʏ : " + jp1+ "\n╰════════════════════╯\n         ™ ᴛᴇᴀᴍ ᴅᴋᴢ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ ™\n")
                    #line.sendContact(to, "u6c878e91cef2d76e95d5f63da51b2193")
...
#-------------------------------------------------------------------------------
  ...
  #==============================================================================#
                    ...
                    ki.sendMessage(msg.to,"bot1")
                    ki2.sendMessage(msg.to,"bot2")
                    ki3.sendMessage(msg.to,"bot3")
                    ki4.sendMessage(msg.to,"bot4")
