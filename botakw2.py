...
line = LINE("EAwCyYMBNJMnwp4o650e.+r+jAIdxZWQoBO38ex8YVG.RJ3N0KN+cFDll7XP2byEqlYM/cdhLv3fjJIOI0RzYPg=")
...
#-------------------------------------------------------------------------------
  ...
  #==============================================================================#
                    ...
                    ki.sendMessage(msg.to,"🔰Ⓓⓚ~ⒷⓄⓣ☯t1")
                    ki2.sendMessage(msg.to,"🔰Ⓓⓚ~ⒷⓄⓣ☯t2")
                    ki3.sendMessage(msg.to,"🔰Ⓓⓚ~ⒷⓄⓣ☯t3")
                    ki4.sendMessage(msg.to,"🔰Ⓓⓚ~ⒷⓄⓣ☯t4")
                    ki5.sendMessage(msg.to,"🔰Ⓓⓚ~ⒷⓄⓣ☯t5")
                    ki6.sendMessage(msg.to,"🔰Ⓓⓚ~ⒷⓄⓣ☯t6")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                ...
                elif text.lower() == 'dk.pulang' or text.lower() == 'bye all' or text.lower() == '0':
                  if msg._from in lineMID:
...
#____________                              
                  ...
                  if len(string) <= 10000000000:
                    ...
                    ki6.sendMessage(msg.to,"Nama diganti jadi " + string + "")                
...
#____________                              
                  ...
                  if len(string) <= 10000000000:
                    ...
                    ki6.sendMessage(msg.to,"Status diganti jadi " + string + "")
#==============================================================================#
                elif text.lower() == 'me':
...
#==============================================================================#
                    ...
                    if msg.to in cctv['point']:
                        ...
                        line.sendMessage(to,"Sider Dk turned Off")
                    else:
