...
ki = LINE("EAgXKZTNuFCfWIUR82K5.8OY1iJbE2cs3otqwBUM9rq.nDoY8YWClKc6ZAAmlRbvRSXbgM1lJpP/8yfLe5ZVsiQ=")
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))


ki2 = LINE("EAbxkM87M0CZlsvXjCCb.x6JXUNwTo2ABeWsGFXEkYW.F3dZFACFT9x/2DZdQJa1qRhxg2wPkXycr1foRZpBQQg=")
ki2.log("Auth Token : " + str(ki2.authToken))
ki2.log("Timeline Token : " + str(ki2.tl.channelAccessToken))


ki3 = LINE("EA1y2UYCuUvT6X8CUYLf.iXDW3NqeZe2QwsaB0p/2tW.fFku35ghyF4073YeRhmPbwWIUDMIyWANae4DzLAi0vU=")
ki3.log("Auth Token : " + str(ki3.authToken))
ki3.log("Timeline Token : " + str(ki3.tl.channelAccessToken))


ki4 = LINE("EA1y2UYCuUvT6X8CUYLf.iXDW3NqeZe2QwsaB0p/2tW.fFku35ghyF4073YeRhmPbwWIUDMIyWANae4DzLAi0vU=")
ki4.log("Auth Token : " + str(ki4.authToken))
ki4.log("Timeline Token : " + str(ki4.tl.channelAccessToken))


ki5 = LINE("EAYZLWauvgLzrxWSrBC7.ysELs5+0aaJPhSRVRuIgzW.z3Hzgll+lV4xNVXFmOBguc8+eqRQ89L3XKAPZXrpe7w=")
...
Bots = [lineMID,kiMID,ki2MID,ki3MID,ki4MID,ki5MID]
...
86.║✍ ᴘʀᴏᴛᴇᴄᴛ sᴇᴛ
87.║✍ ᴘʀᴏᴛᴇᴄᴛ ᴏɴ/ᴏғғ
88.║✍ ʟɪɴᴋᴘʀᴏᴛᴇᴄᴛ ᴏɴ/ᴏғғ
89.║✍ ᴄᴀɴᴄᴇʟᴀʟʟ ᴏɴ/ᴏғғ
90.║✍ ɪɴᴠɪᴛᴇᴘʀᴏᴛᴇᴄᴛ ᴏɴ/ᴏғғ
91.║✍ ᴘʀᴏᴛᴇᴄᴛᴀʟʟ ᴏɴ/ᴏғғ
10.║✍ Promo
11.║✍ Kibar
12.║✍ Dkbot
13.║✍ Mybot
...
#-------------------------------------------------------------------------------
  ...
  #==============================================================================#
                    ...
                    ki.sendMessage(msg.to,"jp1")
                    ki2.sendMessage(msg.to,"jp2")
                    ki3.sendMessage(msg.to,"jp3")
                    ki4.sendMessage(msg.to,"jp4")
                    ki5.sendMessage(msg.to,"jp5")
...
#____________                              
                  ...
                  if len(string) <= 10000000000:
                    ...
                    ki4.sendMessage(msg.to,"Nama diganti jadi " + string + "")
                    ki5.sendMessage(msg.to,"Nama diganti jadi " + string + "")
...
#____________                              
                  ...
                  if len(string) <= 10000000000:
                    ...
                    ki3.sendMessage(msg.to,"Status diganti jadi " + string + "")
                    ki4.sendMessage(msg.to,"Status diganti jadi " + string + "")
                    ki5.sendMessage(msg.to,"Status diganti jadi " + string + "")
#==============================================================================#
                elif text.lower() == 'me':
                	...
                	line.sendContact(to, "u39f6835814970d554809a89e620f8281")
